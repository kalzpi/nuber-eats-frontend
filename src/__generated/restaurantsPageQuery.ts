...
export interface restaurantsPageQuery_restaurants_items_category {
  __typename: "Category";
  name: string;
}

export interface restaurantsPageQuery_restaurants_items {
  __typename: "Restaurant";
  id: number;
  name: string;
  coverImage: string;
  category: restaurantsPageQuery_restaurants_items_category | null;
  address: string;
  isPromoted: boolean;
}
...
export interface restaurantsPageQuery_restaurants {
  ...
  items: restaurantsPageQuery_restaurants_items[] | null;
}
